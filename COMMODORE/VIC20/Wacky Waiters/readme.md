...
**Wacky Waiters Cheat.tap**			<-- TAP File to replace the games original loader
**Wacky Waiters Cheat.md**			<-- Instructions and Type-In if You Prefer
**ScratchPad**						<-- My own notes.
